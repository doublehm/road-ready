...
- [ ] Task: Implement Stripe Account Creation API
    - [ ] Write Tests: Mock Stripe API calls for account creation
    - [ ] Implement Feature: Create endpoint to initiate Connect onboarding in `app/api/instructors.py`
